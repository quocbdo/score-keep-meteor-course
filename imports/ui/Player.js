        ...
        <div className="player">
          <div>
            ...
            <p className="player__stats">
              {this.props.player.position} place - {this.props.player.position} {this.props.player.score} point(s).
            </p>
          </div>
          <div className="player__actions">
            <button className="button button--round" onClick={() => {
              Players.update(this.props.player._id, {$inc: {score: 1}}); // mongoDB operator, increment score by 1
            }}>+1</button>
            <button className="button button--round" onClick={()=> {
